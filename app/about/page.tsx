    ...
    <main className="min-h-screen flex flex-col bg-black text-white px-6 pt-24">
        ...
        <div className="max-w-5xl mx-auto w-full mt-12 flex flex-col md:flex-row items-start gap-8">
            ...
            <div className="md:w-2/3 space-y-6 text-gray-300 leading-relaxed">
                <h2 className="text-2xl font-semibold mb-2 text-gray-100">Filmmaker</h2>
                <p className="mb-10">
                    ...
                    It all began in 2009: I was at home playing on my parents' laptop when I found an intriguing, star-shaped logo on the dock. "What's that?" I wonder, and within 24 hours I had learned the basics, recorded, and edited my very first Youtube video.<br /><br />

                    I'm self-taught. From iMovie to After Effects, Premiere, and finally Davinci Resolve; from a laptop webcam to a Canon G7x, my first Sony a7, and now cinema and film cameras; and from making Youtube videos with my sister in the basement to DP'ing on real sets with a whole team - it all started that morning when I opened iMovie for the first time.<br /><br />

                    I have strong roots in Youtube - for many years I've watched Youtube just to learn how to make better videos for Youtube - which has allowed me to find my style and supercharge my work in film. I'm drawn to movement, high-contrast imagery, and engaging edits that evoke a feeling and matches a story's pace.<br /><br />

                    One thing remains consistent, however: to improve and learn with each project - to tell the story more engagingly, to present visuals more stunningly, and/or to help a team of people do the same.<br /><br />

                </p>

                <h2 className="text-2xl font-semibold mb-2 text-gray-100">Software Engineer</h2>
                <p className="mb-10">
                    ...
                    During my internship at Discovery, Inc., I contributed to an internal web application using Python, Flask, SQL, and HTML/CSS. In addition to application development, I gained exposure to DevOps workflows, automation, and database-driven systems within a large-scale enterprise environement.<br /><br />
